...
public class SudokoMain {
    ...
    public static void main(String[] args) {
        ...
        do{
            SudokoClass sudoko = new SudokoClass(); //cria o objeto onde o rodo ira ser trabalhado
            sudoko.implementnadoEscolhas(incicio());//Passa como parametro a escolha do usuario
